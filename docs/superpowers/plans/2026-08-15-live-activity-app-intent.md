...
- [ ] 위젯 ⏸ 후 앱에서 ▶ → 위젯이 카운트다운으로 갱신되는가
- [ ] 위젯 ⏸ 후 앱에서 ✕ → 위젯이 즉시 사라지는가
- [ ] 위젯 ⏸ 연타 시 남은 시간이 보존되는가
- [ ] 앱을 백그라운드로 보낸 상태에서 위젯 ▶ → 앱 복귀 시 남은 시간이 위젯과 일치하는가
- [ ] 앱 강제 종료 상태에서 ▶/⏸ 후 앱 실행 → 잠금화면에 위젯이 1개만 존재하는가
